...
const Show = ({ book: propBook, bookId }) => {
  const [quantity, setQuantity] = useState(1);

  // Use provided book or find by ID from sample data
  const book = propBook || sampleBooks.find(b => b.id === parseInt(bookId)) || sampleBooks[0];

  const handleAddToCart = () => {
    console.log(`Adding ${quantity} copies of "${book.title}" to cart`);
    // In Laravel, this would be an API call
  };
